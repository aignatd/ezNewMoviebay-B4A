...
public class searcview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "newmoviebay.mncplaymedia.com.searcview");
            if (htSubs == null) {
                ba.loadHtSubs(this.getClass());
                htSubs = ba.htSubs;
            }
            if (BA.isShellModeRuntimeCheck(ba)) {
			    ba.raiseEvent2(null, true, "CREATE", true, "newmoviebay.mncplaymedia.com.searcview",
                    ba);
                return;
		    }
        }
...
innerInitialize(_ba);
try {
		Debug.PushSubsStack("Initialize (searcview) ","searcview",19,ba,this,7);
