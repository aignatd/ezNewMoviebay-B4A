...
public class webview extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "newmoviebay.mncplaymedia.com", "newmoviebay.mncplaymedia.com.webview");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "newmoviebay.mncplaymedia.com", "newmoviebay.mncplaymedia.com.webview");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "newmoviebay.mncplaymedia.com.webview", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
try {
		Debug.PushSubsStack("Activity_Create (webview) ","webview",15,mostCurrent.activityBA,mostCurrent,19);
Debug.locals.put("FirstTime", _firsttime);
 BA.debugLineNum = 19;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 22;BA.debugLine="Activity.LoadLayout(\"Payement\")";
Debug.ShouldStop(2097152);
mostCurrent._activity.LoadLayout("Payement",mostCurrent.activityBA);
 BA.debugLineNum = 23;BA.debugLine="wvPay.LoadURL(\"http://202.43.73.36/v1_ecommerce_devel/payment.php\")";
Debug.ShouldStop(4194304);
mostCurrent._wvpay.LoadUrl("http://202.43.73.36/v1_ecommerce_devel/payment.php");
 BA.debugLineNum = 24;BA.debugLine="wvPay.ZoomEnabled = False";
Debug.ShouldStop(8388608);
mostCurrent._wvpay.setZoomEnabled(anywheresoftware.b4a.keywords.Common.False);
...
try {
		Debug.PushSubsStack("Activity_Pause (webview) ","webview",15,mostCurrent.activityBA,mostCurrent,32);
...
try {
		Debug.PushSubsStack("Activity_Resume (webview) ","webview",15,mostCurrent.activityBA,mostCurrent,28);
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 16;BA.debugLine="Private wvPay As WebView";
